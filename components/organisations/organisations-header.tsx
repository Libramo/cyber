  ...
  return (
    <section className="relative bg-slate-900 border-b border-slate-800 py-20 px-6 sm:px-12 lg:px-24 xl:px-32 overflow-hidden">
      ...
      >
        ...
        >
          Notre <span className="text-sky-400">organisation</span>
        </h1>
        <p
          className="mt-4 text-sm text-slate-400 max-w-xl leading-relaxed"
          style={{ fontFamily: "var(--font-ibm)" }}
        >
          L'agence est organisée autour d'une direction générale forte, appuyée
          par un conseil de gouvernance indépendant et des unités
